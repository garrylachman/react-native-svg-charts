...
export declare function LineChart<T>(props:ChartProps<T>):React.ReactElement<ChartProps<T>>;
...
export declare function AreaChart<T>(props:AreaChartProps<T>):React.ReactElement<AreaChartProps<T>>;
